...
## 1. `negrw-deck.md` — Negative-weight reweighting (54 slides)
...
| `breakdown_vs_AN.png` | our MC-stat ~41% vs AN-23-102's 6.2% |
...
⚠️ `breakdown_vs_AN.png` is dated 2026-06-17 and its **empty "Charm-tag" bar is now out of
date** — `CMS_ctag2d_2022` was added 2026-07-22. The slide says so explicitly.
