...
blocks, 8 heads, embed 128. \textbf{2.144\,M} params baseline,
\textbf{2.194\,M} with the feature block \smallnote{($+0.051$\,M)}.
\smallskip

\textbf{Data.} JetClass, 10 classes, $\sim$\textbf{20.05\,M} test jets
...
\begin{columns}[T]
\begin{column}{0.5\textwidth}
\textbf{Aggregate test accuracy} ($\sim$20.05\,M jets)
\smallskip
...
\small An \textbf{early gain in every class} --- Tbqq 1.095$\pm$0.016, Wqq
1.036$\pm$0.004 --- that \textbf{decays to nothing by 1\,M}. Wqq has the
\emph{fewest} splittings (21.6/jet) yet still gains at $\sim$9$\sigma$:
\textbf{not confined to complex or $b$-containing jets}. At convergence all three
arms are \textbf{null-or-worse}.
\end{block}
