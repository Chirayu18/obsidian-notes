...
| Patel & Ganguly — *Explainable AI for Jet Tagging in the Lund Jet Plane* | [2604.25885](https://arxiv.org/abs/2604.25885) | **Independent support for the arity argument.** ParT correlates with τ21/τ32/C2/C3 at \|ρ\|≈0.5-0.6 vs 0.4 for LundNet/ParticleNet; concludes "pairwise attention biases are particularly well-suited" for N-point correlators. See [[2026-09-14-xai-interp-papers-and-our-null]]. PDF: [[2604.25885-PatelGanguly-XAI-jet-tagging-lund-plane.pdf]] |
| Rai & Ganguly — *Dissecting Jet-Tagger Through Mechanistic Interpretability* | [2605.09881](https://arxiv.org/abs/2605.09881) | Causal ablation of ParT's pairwise features: zeroing **ln kT costs the most (+4.44)**, zeroing **ln z slightly HELPS (-2.69)** — and PLuM's tokens are [ln kT, ln 1/ΔR, ln z]. 6-head circuit recovers 97.3% of AUC; class info already at AUC≈0.97 in the particle layers. Same PDF dir. |
